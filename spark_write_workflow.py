...
from ppl_datalake_spark.migration.sparkify_json import generate_schema
from ppl_datalake.ppl_api import PPLApi
import pandas as pd
...
if __name__ == '__main__':
    ...
    handler = RotatingFileHandler('spark_workflow.log', maxBytes=20*1024*1024, backupCount=1)
    ...
    url = "jdbc:mysql://10.10.2.244:3306/ars_prod"
    ...
    output_table = 'workflows'
    sql = """
        (
            SELECT workflow_id, workflow_type, workflow_name, user, workflow_input, workflow_output, log, workflow_status, priority, tag _tag, create_time, update_time, batch_id_id, hook, device, tos_id, device_num, data_source, category, upload_ttl, bag_nums, metric
            FROM workflow
    ...
    with db.connect() as conn:
        ...
        # migrate_day_results(datetime(2023,4,9), datetime(2023,4,10))
